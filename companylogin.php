...
// session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        //read from database
            $query = "select * from company where companyemail = '$email' limit 1";
            ...
            if($result)
            {
                if($result && mysqli_num_rows($result) > 0)
                {
                    ...
                    if($company_data['companypassword'] === $password)
                    {

                        $_SESSION['companyemail'] = $company_data['companyemail'];
...
<head>
    ...
    <!-- Title Page-->
    <title>PHINMA UPang Alumni Tracker | Company</title>
