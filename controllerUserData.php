...
//}
    ...
    if(isset($_POST['check-email'])){
        ...
        $check_email = "SELECT * FROM alumni WHERE email='$email'";
        $run_sql = mysqli_query($openconnection, $check_email);
        if(mysqli_num_rows($run_sql) > 0){
            $code = rand(999999, 111111);
            $insert_code = "UPDATE alumni SET code = $code WHERE email = '$email'";
    ...
    if(isset($_POST['check-reset-otp'])){
        ...
        $check_code = "SELECT * FROM alumni WHERE code = $otp_code";
    ...
    if(isset($_POST['change-password'])){
        ...
        if($password !== $cpassword){
            ...
            // $encpass = password_hash($password, PASSWORD_BCRYPT);
            $update_pass = "UPDATE alumni SET code = $code, password = '$password' WHERE email = '$email'";
